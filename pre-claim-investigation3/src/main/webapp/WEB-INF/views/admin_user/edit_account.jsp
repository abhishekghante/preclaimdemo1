        ...
        <div class="box-body">
                  ...
                  <select name="account_type" id="account_type" class="form-control selecter_1" tabindex="-1">
                    ...
                    if($role_lists){
                      foreach ($role_lists as $roleInfo) {
                        ...
                        ?><option <?php if($account_type == $roleInfo->roleId){ echo 'selected'; } ?> value="<?php echo $roleInfo->roleId; ?>"><?= rawurldecode($roleInfo->role); ?></option><?php
                      }
                    }
                    ?>
                  </select>
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <a href="javascript:void(0);">
                    <?php
                    if($user_image){ ?>
                      <img src="<?php echo $user_image; ?>" id="account_picture" style="height:160px;width: auto;" data-src="#" /> <br />
                    <?php
                    }else {
                    ?>
                  ...
                  <input type="hidden" id="account_img" name="account_img" value="<?php echo $user_image; ?>"/>
                </div>
              </div>
            </div>
            <div class="col-md-6">
          ...
          <div class="box-footer">
            <div class="col-md-offset-2 col-md-10">
              ...
              <button class="btn btn-info" id="editaccountsubmit" onClick="return updateAccountValidate();" type="button">Update</button>
              <a href="<?= base_url(); ?>users" class="btn btn-danger" value="">Back</a>
            </div>
          </div>
        </div>
      </form>

			...
			<div class="portlet-title">
				<div class="caption">
					<i class="icon-users font-green-sharp"></i> <span
						class="caption-subject font-green-sharp sbold"> <!-- <?= (($regionId)?'Update':'Add'); ?> -->
						Region
					</span>
				</div>
			</div>
			...
			<div class="portlet-body">
				...
				<form novalidate="" id="add_region_form" role="form" method="post"
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" required="" id="regionName"
										name="regionName" class="form-control"
                  ...
                  if($regionId){ ?>  -->
									...
									<a
										href="${pageContext.request.contextPath}/region/pending_region"
			...
			$
					.ajax({
						...
						beforeSend : function() {
							$("#addregionsubmit")
									.html(
											'<img src="'+adminurl+'${pageContext.request.contextPath}/resources/img/input-spinner.gif"> Loading...');
			...
			$
					.ajax({
						...
						beforeSend : function() {
							$("#editregionsubmit")
									.html(
											'<img src="'+adminurl+'assets/img/input-spinner.gif"> Loading...');

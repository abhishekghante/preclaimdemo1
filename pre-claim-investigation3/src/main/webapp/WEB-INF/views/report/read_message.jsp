    ...
    <div class="portlet box">
      <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green-sharp sbold">Read Cases</span>
        </div>
        <div class="actions">
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-md-12 table-container">
                <div class="box-body no-padding">
                  <div class="">
                    <table id="read_message_list" class="table table-striped table-bordered table-hover table-checkable dataTable data-tbl">
                      <thead>
...
$(document).ready(function() {
  ...
  /*
  table = $('#read_message_list').DataTable({
      language: {
      ...
      "ajax": {
          ...
          "url": "<?php echo site_url('/report/readmessages/messageTableResponse')?>",
          "type": "POST"
      },
  ...
  */
  var i = 0;
  $('#read_message_list tfoot th').each( function () {
    if( i == 1 || i == 2 ){
  ...
  // DataTable
  var table = $('#read_message_list').DataTable();

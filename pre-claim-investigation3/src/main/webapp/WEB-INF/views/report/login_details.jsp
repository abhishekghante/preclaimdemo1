    ...
    <div class="portlet box">
      <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green-sharp sbold">Login Details</span>
        </div>
        <div class="actions">
        </div>
      </div>
                    ...
                    <table id="viewrating_list" class="table table-striped table-bordered table-hover table-checkable dataTable data-tbl">
                      <thead>
                        <tr class="tbl_head_bg">
                          ...
                          <th class="head1 no-sort">Login Date Time</th>
                        </tr>
                      </thead>
                      <tfoot>
                        <tr class="tbl_head_bg">
...
$(document).ready(function() {
  ...
  table = $('#viewrating_list').DataTable({
      ...
      "ajax": {
          ...
          "url": "<?php echo site_url('/report/loginDetails/loginTableResponse')?>",
          "type": "POST"
      },

    ...
    <div class="portlet box">
      <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject font-green-sharp sbold">Favourite Cases</span>
        </div>
        <div class="actions">
        </div>
      </div>
                    ...
                    <table id="favorite_message_list" class="table table-striped table-bordered table-hover table-checkable dataTable data-tbl">
                      <thead>
                        <tr class="tbl_head_bg">
                          <th class="head1 no-sort">Cases ID</th>
                          <th class="head1 no-sort">Cases Title(Eng)</th>
                          <th class="head1 no-sort">Cases Title(Hindi)</th>
...
$(document).ready(function() {
  ...
  table = $('#favorite_message_list').DataTable({
      ...
      "ajax": {
          ...
          "url": "<?php echo site_url('/report/favouritemessage/messageTableResponse')?>",
          "type": "POST"
      },

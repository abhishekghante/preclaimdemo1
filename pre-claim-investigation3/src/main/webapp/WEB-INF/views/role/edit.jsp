<div class="form-group">
    ...
    <div class="col-md-4 col-sm-4">
      <input type="text" required="" maxlength="30" placeholder="Enter Role Name" id="role" value="<?=rawurldecode($roleInfo->role);?>" class="form-control" name="role">
    </div>
</div>
<div class="form-group">
    <label class="col-md-2 col-sm-2 control-label" for="role_code">Role Code</label>
    <div class="col-md-4 col-sm-4">
      <input type="text" required="" maxlength="10" placeholder="Enter Role Code" id="role_code" value="<?=$roleInfo->role_code;?>" class="form-control username" name="role_code">
    </div>
</div>
...
<script type="text/javascript">
    function updateRole() {
        ...
        $.ajax({
            type    : 'POST',
            url     : adminurl + 'users/updateRole',
            data    : data,
            beforeSend: function() { 
                $("#updaterolesubmit").html('<img src="'+adminurl+'assets/img/input-spinner.gif"> Loading...');
